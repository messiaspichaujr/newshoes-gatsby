    ...
    <div className="app-wrapper">
        ...
        <div style={{
          ...
          <div style={{ flex: '1', minWidth: '280px', paddingBottom: '60px', color: '#fff' }}>
            ...
            <h1 style={{
              ...
              fontWeight: '800', margin: '16px 0 32px', color: '#fff', lineHeight: 1.1,
            }}>
              {u.nome}
            </h1>
            {whatsappHref && (
      ...
      <section style={{ backgroundColor: '#F5F5F7', padding: '60px 20px 100px' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          {/* Back link */}
          <a href="/#locator" style={{
            display: 'inline-flex', alignItems: 'center', gap: '8px',
            color: '#1CAAD9', textDecoration: 'none', marginBottom: '32px',
            fontWeight: '600', fontFamily: 'Inter, sans-serif', fontSize: '14px',
          }}>
            <ArrowLeft size={16} /> {t('unidade.back')}
          </a>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '32px', alignItems: 'flex-start' }}>
              <div style={{ flex: '1', minWidth: '260px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                  {u.endereco && (
                    <ContactRow icon={<MapPin size={18} color="#1CAAD9" />}>
                      {u.endereco}
                    </ContactRow>
                  )}
                  {u.whatsapp && (
                  ...
                  {u.facebook && (
                    <ContactRow icon={<Facebook size={18} color="#1CAAD9" />}>
                      <a
                        href={u.facebook.startsWith('http') ? u.facebook : `https://facebook.com/${u.facebook}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{ color: '#555', textDecoration: 'none' }}
                      >
              ...
              {/* Map placeholder / directions CTA */}
              {u.endereco && (
                <a
              ...
              <div key={plan.key} style={{
                ...
                {plan.badge && (
                  <span style={{
                    ...
                    padding: '4px 14px', borderRadius: '20px', fontFamily: 'Inter, sans-serif',
                    whiteSpace: 'nowrap',
                  }}>
                    {t(plan.badge)}
                  </span>
